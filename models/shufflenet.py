    ...
    def __init__(self, inp, oup, stride):
        ...
        if self.stride > 1:
            self.branch1 = nn.Sequential(
                self.depthwise_conv(inp, inp, kernel_size=3, stride=(self.stride,1), padding=1),
                nn.BatchNorm2d(inp),
        ...
        self.branch2 = nn.Sequential(
            ...
            nn.BatchNorm2d(branch_features),
            nn.ReLU(inplace=True),
            self.depthwise_conv(branch_features, branch_features, kernel_size=3, stride=(self.stride,1), padding=1),
            nn.BatchNorm2d(branch_features),
